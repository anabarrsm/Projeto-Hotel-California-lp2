...
class AreaComumControllerTest {
	...
	@Test
		public void disponibilizarAreaComum() {
			assertEquals(this.areaComumController.disponibilizarAreaComum("ADM1", "AUDITORIO", "Auditorio Nilo Pecanha", LocalTime.of(8,0), LocalTime.of(18,0), 0.0, true, 100), "cade");
		}
}