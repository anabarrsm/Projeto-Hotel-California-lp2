...
class HotelCaliforniaSistemaSprint1MinTest {
    ...
    String idAuditorio, idCinema, idPiscina, idSalaoDeFestas, idArea;
    String idReservaAuditorio, idReservaCinema, idReservaPiscina, idReservaSalaoDeFestas;
    String idFormaPagamentoPIX, idFormaPagamentoDinheiro, idFormaPagamentoCartao;
    String idPagamentoDinheiroAuditorio, idPagamentoPixCinema, idPagamentoPixPiscina, idPagamentoCartaoSalaoDeFestas;
    ...
    class US02Validations {
        ...
        void testCadastrarQuartoSingle() {
            String resultado = driver.disponibilizarQuartoSingle("ADM1", 301, 80.0, 20.0);
            assertAll(
        ...
        void testUsuarioAutenticacaoNaoExisteAoCadastrarQuarto() {
            HotelCaliforniaException hce = assertThrows(HotelCaliforniaException.class, () -> {
                driver.disponibilizarQuartoSingle("ADM2", 301, 80.0, 20.0);
            });
            assertTrue(hce.getMessage().toUpperCase().contains("USUARIO NAO EXISTE"));
        }
        ...
        void testQuartoJaExiste() {
            driver.disponibilizarQuartoSingle("ADM1", 301, 80.0, 20.0);
            HotelCaliforniaException hce = assertThrows(HotelCaliforniaException.class, () -> {
                driver.disponibilizarQuartoDouble("ADM1", 301, 110.0, 20.0, new String[]{"frigoba"});
            });
        ...
        void testUsuarioAutenticacaoNaoAdminAoCadastrarQuarto() {
            String cliente = extrairId(driver.cadastrarUsuario("ADM1", "Novo Cliente", "CLI", 123456L));
            HotelCaliforniaException hce = assertThrows(HotelCaliforniaException.class, () -> {
                driver.disponibilizarQuartoSingle(cliente, 301, 80.0, 20.0);
            });
        ...
        void testCadastrarQuartoDouble() {
            String resultado = driver.disponibilizarQuartoDouble("ADM1", 301, 80.0, 20.0, new String[]{"cama extra infantil", "agua quente"});
            assertAll(
        ...
        public void exibirQuartoSingle() {
            String quartoIdStr = extrairId(driver.disponibilizarQuartoSingle("ADM1", 301, 80.0, 20.0));
            String resultado = driver.exibirQuarto(Long.valueOf(quartoIdStr));
            assertAll(
        ...
        public void exibirQuartoDouble() {
            String quartoIdStr = extrairId(driver.disponibilizarQuartoDouble("ADM1", 301, 80.0, 20.0, new String[]{"Frigobar"}));
        ...
        void testListar() {
            ...
            String quartoDouble = driver.disponibilizarQuartoDouble("ADM1", 501, 80.0, 20.0, new String[]{"cama extra infantil", "agua quente"});
            String quartoFamily = driver.disponibilizarQuartoFamily("ADM1", 201, 80.0, 20.0, new String[]{"cama extra infantil", "agua quente"}, 10);
    ...
    class US06Validations {
        ...
        public void testExibirReservaProprioCliente() {
            ...
            assertAll(
                    ...
                    () -> assertTrue(resultado.contains("por pessoa: R$10,00")),
                    () -> assertTrue(resultado.contains("VALOR TOTAL DA RESERVA: R$80,00 x2 (diarias) => R$160,00")),
                    () -> assertTrue(resultado.contains("SITUACAO DO PAGAMENTO: PENDENTE."))
            );
        }
        ...
        public void testExibirReservaDeClienteGerente() {
            ...
            assertAll(
                    ...
                    () -> assertTrue(resultado.contains("por pessoa: R$10,00")),
                    () -> assertTrue(resultado.contains("VALOR TOTAL DA RESERVA: R$120,00 x2 (diarias) => R$240,00")),
                    () -> assertTrue(resultado.contains("SITUACAO DO PAGAMENTO: PENDENTE."))
            );
        }
        ...
        public void testExibirReservaDeClienteFuncionario() {
            ...
            assertAll(
                    ...
                    () -> assertTrue(resultado.contains("por pessoa: R$10,00")),
                    () -> assertTrue(resultado.contains("VALOR TOTAL DA RESERVA: R$190,00 x2 (diarias) => R$380,00")),
                    () -> assertTrue(resultado.contains("SITUACAO DO PAGAMENTO: PENDENTE."))
            );
        }
        ...
        public void testListarReservasAtivasDoClientePorTipoGerente() {
            String[] resultado = driver.listarReservasAtivasDoClientePorTipo(idGerente, idClienteA, "RESTAURANTE");
            assertAll(
        ...
        public void testListarReservasAtivasDoClientePorTipoFuncionario() {
            String[] resultado = driver.listarReservasAtivasDoClientePorTipo(idFuncionario, idClienteA, "PISCINA");
            assertAll(
                    () -> assertEquals(1, resultado.length)
            );
        }
        ...
        public void testListarReservasAtivasPorTipoFuncionario() {
            driver.reservarPiscina(idGerente, idClienteB, Long.parseLong(idPiscina),
                    dataInicio.minusDays(3), dataFim.minusDays(3), 10, "infantil");
            String[] resultado = driver.listarReservasAtivasPorTipo(idFuncionario, "PISCINA");
            assertAll(
                    () -> assertEquals(2, resultado.length)
            );
        }
        ...
        @Test
        @DisplayName("CA.06.1: Listar Reservas (inclusive inativas) de Todos os Clientes: o proprio cliente")
        public void testListarReservasTodasProprioCliente() {
            try (MockedStatic<LocalDateTime> mocked = Mockito.mockStatic(LocalDateTime.class)) {
                mocked.when(LocalDateTime::now).thenReturn(LocalDateTime.of(2024, Month.DECEMBER, 31, 20, 0));
                driver.reservarQuartoSingle(idGerente, idClienteB, Integer.parseInt(numQuartoSingle),
                        dataInicio.minusDays(3), dataFim.minusDays(3), new String[]{idRefCafeMatinal});
                String[] resultado = driver.listarReservasTodas(idClienteA);
                assertAll(
                        () -> assertEquals(7, resultado.length)
                );
            }
        ...
        @Test
        @DisplayName("CA.06.1: Listar Reservas (inclusive inativas) de Todos os Clientes: gerente")
        public void testListarReservasTodasGerente() {
            try (MockedStatic<LocalDateTime> mocked = Mockito.mockStatic(LocalDateTime.class)) {
                mocked.when(LocalDateTime::now).thenReturn(LocalDateTime.of(2024, Month.DECEMBER, 31, 20, 0));
                driver.reservarRestaurante(idGerente, idClienteB, dataInicio.minusDays(3), dataFim.minusDays(3),
                        10, "JANTAR");
                String[] resultado = driver.listarReservasTodas(idGerente);
                assertAll(
                        () -> assertEquals(8, resultado.length)
                );
            }
        ...
        @Test
        @DisplayName("CA.06.1: Listar Reservas (inclusive inativas) de Todos os Clientes: Funcionario")
        public void testListarReservasTodasFuncionario() {
            try (MockedStatic<LocalDateTime> mocked = Mockito.mockStatic(LocalDateTime.class)) {
                mocked.when(LocalDateTime::now).thenReturn(LocalDateTime.of(2024, Month.DECEMBER, 31, 20, 0));
                driver.reservarPiscina(idGerente, idClienteB, Long.parseLong(idPiscina),
                        dataInicio.minusDays(3), dataFim.minusDays(3), 10, "infantil");
                String[] resultado = driver.listarReservasTodas(idFuncionario);
                assertAll(
                        () -> assertEquals(8, resultado.length)
                );
            }
        ...
        @Test
        @DisplayName("CA.06.1: Listar Reservas (inclusive inativas) de Todos os Clientes: Administrador (nao autorizado)")
        void testListarReservasTodasAdm() {
            try (MockedStatic<LocalDateTime> mocked = Mockito.mockStatic(LocalDateTime.class)) {
                mocked.when(LocalDateTime::now).thenReturn(LocalDateTime.of(2024, Month.DECEMBER, 31, 20, 0));
                HotelCaliforniaException hce = assertThrows(HotelCaliforniaException.class, () -> {
                    driver.listarReservasTodas("ADM1");
                });
                assertTrue(hce.getMessage().toUpperCase().contains("NAO E POSSIVEL PARA USUARIO"));
                assertTrue(hce.getMessage().toUpperCase().contains("EXIBIR/LISTAR RESERVA(S) DO CLIENTE"));
            }
        ...
        @Test
        @DisplayName("CA.06.2: Listar Reservas (inclusive inativas) de Todos os Clientes: Nao existem reservas")
        void testListarReservasTodasNaoExiste() {
            try (MockedStatic<LocalDateTime> mocked = Mockito.mockStatic(LocalDateTime.class)) {
                mocked.when(LocalDateTime::now).thenReturn(LocalDateTime.of(2024, Month.DECEMBER, 31, 20, 0));
                ReservasSessionController.getInstance().init();
                HotelCaliforniaException hce = assertThrows(HotelCaliforniaException.class, () -> {
                    driver.listarReservasTodas(idGerente);
                });
                assertTrue(hce.getMessage().toUpperCase().contains("RESERVA NAO ENCONTRADA"));
            }
        }
    ...
    class US08Validations {
        ...
        public void testPagarReservaComDinheiro() {
            ...
            assertAll(
                    ()-> assertTrue(resultado.contains("SITUACAO DO PAGAMENTO: REALIZADO")),
                    ()-> assertTrue(resultado.contains("Forma de pagamento: DINHEIRO (10% de desconto em pagamentos")),
                    ()-> assertTrue(resultado.contains("Total Efetivamente Pago: R$1.062,00 em 1x de R$1.062,00"))
            );
        }
    ...
    private void reservationsPreProcessor() {
        ...
        idCinema = extrairId(driver.disponibilizarAreaComum("ADM1","CINEMA", "Cinema Gold",
                LocalTime.of(14,0), LocalTime.of(22,0), 5.0, true, 20));
        idPiscina = extrairId(driver.disponibilizarAreaComum("ADM1","PISCINA", "Piscina Geral Adulto",
                LocalTime.of(8,0), LocalTime.of(22,0), 0.0, true, 25));
        idSalaoDeFestas = extrairId(driver.disponibilizarAreaComum("ADM1","SALAO_DE_FESTAS", "Salao Principal",
        ...
        idReservaCinema = extrairId(driver.reservarCinema(idGerente, idClienteA, Long.parseLong(idCinema),
                dataInicio, dataFim,  20, new String[]{"Titanic"}));
        idReservaPiscina = extrairId(driver.reservarPiscina(idGerente, idClienteA, Long.parseLong(idPiscina),
                dataInicio, dataFim,  25, "Semi-olimpica (com raia, 25m)"));
        idReservaSalaoDeFestas = extrairId(driver.reservarSalaoDeFestas(idGerente, idClienteA, Long.parseLong(idSalaoDeFestas),
                dataInicio, dataFim,  100, false, true));

        idFormaPagamentoPIX = extrairId(driver.disponibilizarFormaDePagamento("ADM1", "PIX", 5.0));
        idFormaPagamentoDinheiro = extrairId(driver.disponibilizarFormaDePagamento("ADM1", "DINHEIRO", 10.0));
        idFormaPagamentoCartao = extrairId(driver.disponibilizarFormaDePagamento("ADM1", "CARTAO DE CREDITO", 0.0));
    }
